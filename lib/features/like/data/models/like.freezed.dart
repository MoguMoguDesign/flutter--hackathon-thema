...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Like&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.haikuId, haikuId) || other.haikuId == haikuId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// Create a copy of Like
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? haikuId = null,Object? createdAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,haikuId: null == haikuId ? _self.haikuId : haikuId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String haikuId,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Like() when $default != null:
return $default(_that.id,_that.userId,_that.haikuId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String haikuId,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Like():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String haikuId,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Like() when $default != null:
return $default(_that.id,_that.userId,_that.haikuId,_that.createdAt);case _:
  return null;
...
class _Like extends Like {
  const _Like({required this.id, required this.userId, required this.haikuId, required this.createdAt}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Like&&(identical(other.id, id) || other.id == id)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.haikuId, haikuId) || other.haikuId == haikuId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}
...
/// Create a copy of Like
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? haikuId = null,Object? createdAt = null,}) {
  return _then(_Like(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,haikuId: null == haikuId ? _self.haikuId : haikuId // ignore: cast_nullable_to_non_nullable
